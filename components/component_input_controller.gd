...
@onready var player_movement = get_node("../component_movement")

func _physics_process(_delta: float) -> void:
	
	#Direction
	var direction := Input.get_vector("move_right","move_left","move_forward","move_backward")
	get_parent().input_controller.emit("direction",direction)
	#Jumping
