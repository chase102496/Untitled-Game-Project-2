...
func _on_button_mouse_entered() -> void:
	...
	description_label.text = str(
		Battle.get_type_color("VIS"),Battle.type.VIS.ICON,"[/color] ",ability.vis_cost,"  ",Battle.get_type_color_dict(ability.type),ability.type.ICON,"[/color] ",ability.type.TITLE,"\n",
		ability.description,"\n",
		"\n",
