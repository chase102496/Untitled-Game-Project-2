...
func world_initialize(scene_new : String = "res://Levels/dream_garden.tscn"): #TODO FIXME
	...
	if Global.player.my_component_party.my_party[0]: #If we have a primary dreamkin
		final_entity_list.append(str("world_",Global.player.my_component_party.my_party[0].glossary)) #Add our primary dreamkin's id
