...
func _ready() -> void:
	...
	_update_label(owner.owner.my_component_health.health,health,owner.owner.my_component_health.health)
	_update_label(owner.owner.my_component_vis.vis,vis,owner.owner.my_component_vis.vis)
